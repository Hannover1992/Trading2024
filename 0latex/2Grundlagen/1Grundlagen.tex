...
% \input{2Grundlagen/13PID}
% \input{2Grundlagen/14PWM}

\section{Informationstechnologie}

\input{2Grundlagen/21NeuronaleNetze}
\input{2Grundlagen/22ForwardPropagation}
\input{2Grundlagen/23BackPropagation}
\input{2Grundlagen/23Optimierungstechniken}
\input{2Grundlagen/24Overfitting}
\input{2Grundlagen/25VanischinExplodingGradient}
\input{2Grundlagen/26LearningRAte}
\input{2Grundlagen/27Batch}
\section{Reinforcement Learning}
\input{2Grundlagen/30ReinforcementLearning}
\input{2Grundlagen/31MarkovscheProcess}
\input{2Grundlagen/32Bandit}
\input{2Grundlagen/32Bellman}
\input{2Grundlagen/33PolicyBasedMethod}
\input{2Grundlagen/33Q_Learning}
\input{2Grundlagen/34DDPG}
\input{2Grundlagen/41TradingReward.tex}
